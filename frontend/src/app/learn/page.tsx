...
import { ArrowLeft, BookOpen, CheckCircle, PlayCircle, Award, Hourglass, HelpCircle, ChevronRight, ChevronLeft } from "lucide-react";
...
export default function LearningWorkspace() {
  ...
  useEffect(() => {
    ...
    if (activeLessonId) {
      ...
      // Check if it's the final quiz (could be course-level)
      // We will fetch quiz details directly from API
